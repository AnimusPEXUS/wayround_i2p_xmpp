...
wayround_i2p.utils.factory.class_generate_attributes_and_check(Empty, ['tag'])
...
wayround_i2p.utils.lxml.check_tagname_class_attrnames(N_ELEMENTS)
...
wayround_i2p.utils.lxml.simple_exchange_class_factory(
    N,
    'N',
    NAMESPACE,
    N_ELEMENTS,
...
wayround_i2p.utils.lxml.checker_factory(
    N,
    N_ELEMENTS
    )
...
wayround_i2p.utils.lxml.check_tagname_class_attrnames(PHOTO_ELEMENTS)
...
wayround_i2p.utils.lxml.check_tagname_class_attrnames(ADR_ELEMENTS)
...
wayround_i2p.utils.lxml.check_tagname_class_attrnames(LABEL_ELEMENTS)
...
wayround_i2p.utils.lxml.check_tagname_class_attrnames(TEL_ELEMENTS)
...
wayround_i2p.utils.lxml.check_tagname_class_attrnames(EMAIL_ELEMENTS)
...
wayround_i2p.utils.lxml.check_tagname_class_attrnames(GEO_ELEMENTS)
...
wayround_i2p.utils.lxml.check_tagname_class_attrnames(LOGO_ELEMENTS)
...
wayround_i2p.utils.lxml.check_tagname_class_attrnames(ORG_ELEMENTS)
...
wayround_i2p.utils.lxml.check_tagname_class_attrnames(CATEGORIES_ELEMENTS)
...
wayround_i2p.utils.lxml.check_tagname_class_attrnames(SOUND_ELEMENTS)
...
wayround_i2p.utils.lxml.check_tagname_class_attrnames(CLASS_ELEMENTS)
...
wayround_i2p.utils.lxml.check_tagname_class_attrnames(KEY_ELEMENTS)
...
class XCardTemp:
    ...
    def new_from_element(cls, element):
        ...
        wayround_i2p.utils.lxml.subelems_to_order(
            element, order,
            VCARD_ELEMENTS
            )
    ...
    def gen_element(self):
        ...
        wayround_i2p.utils.lxml.order_to_subelems(
            self.get_order(), el
            )
...
wayround_i2p.utils.lxml.check_tagname_class_attrnames(VCARD_ELEMENTS)
